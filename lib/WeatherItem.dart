      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(weather.main == 'Clouds' ? 'Cloudy' : weather.main , style: new TextStyle(color: Colors.black, fontSize: 24.0)),
            Text('${weather.temp.toString()}°C',  style: new TextStyle(color: Colors.black)),
            Image.network('https://openweathermap.org/img/w/${weather.icon}.png', scale: 1,),
